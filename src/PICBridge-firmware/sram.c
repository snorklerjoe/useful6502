...
int ____SRAM_write_bytes(uint32_t addr, int len, const uint8_t* data) {
    // Placeholder: implement actual SRAM write logic
    return -1;
}

int ____SRAM_read_bytes(uint32_t addr, int len, uint8_t* data) {
    // Placeholder: implement actual SRAM read logic
    return -1;
}
