	...
	; Compiler options:
	;
	; -q --opt=none --chip=16f15385 --runtime=+config m95_eeprom.p1 \
	; hardware.p1 main.p1 sram.p1 mcc_generated_files/spi/src/mssp1.p1 \
	; mcc_generated_files/i2c_host/src/mssp2.p1 \
	; mcc_generated_files/uart/src/eusart2.p1 \
	; mcc_generated_files/system/src/config_bits.p1 \
	; mcc_generated_files/system/src/clock.p1 \
	; mcc_generated_files/system/src/system.p1 \
	; mcc_generated_files/system/src/interrupt.p1 \
	; mcc_generated_files/system/src/pins.p1 conio.p1 -omain.hex \
